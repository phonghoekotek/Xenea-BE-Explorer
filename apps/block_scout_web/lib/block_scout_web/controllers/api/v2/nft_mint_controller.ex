...
defmodule BlockScoutWeb.API.V2.NftMintController do
  @moduledoc """
  GET /api/v2/nfts/mints — latest NFT mints (transfers from the zero address).
  """
  ...
  def nft_mints(conn, params) do
    render_token_transfers(conn, params, &TokenTransfer.fetch_nft_mints/1)
  end
